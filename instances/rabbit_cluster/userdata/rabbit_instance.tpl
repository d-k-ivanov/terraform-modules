...
- /usr/sbin/rabbitmqctl set_user_tags username administrator
# Setting permissions to the admin user to the two vhosts we have.
- /usr/sbin/rabbitmqctl set_permissions -p / username ".*" ".*" ".*"
- /usr/sbin/rabbitmqctl set_permissions -p /main/ username ".*" ".*" ".*"
